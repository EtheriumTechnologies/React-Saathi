    ...
    return(
        <div className="dashboard_sidebar" style={{width:toggleSidebar?'250px':'70px'}}>
            <div className="dashboard_sidebar_section">
                ...
                <NavLink to="/" className={({ isActive }) => (isActive ? 'dashboard_sidebar_element active' : 'dashboard_sidebar_element')} style={{justifyContent:toggleSidebar?'':'center'}}>
                ...
                <NavLink to="/professors" className={({ isActive }) => (isActive ? 'dashboard_sidebar_element active' : 'dashboard_sidebar_element')} style={{justifyContent:toggleSidebar?'':'center'}}>
                    <div className="flex items-center gap-2 dashboard_sidebar_element_main">
                ...
                <NavLink to="/students" className={({ isActive }) => (isActive ? 'dashboard_sidebar_element active' : 'dashboard_sidebar_element')} style={{justifyContent:toggleSidebar?'':'center'}}>
                    <div className="flex items-center gap-2 dashboard_sidebar_element_main">
